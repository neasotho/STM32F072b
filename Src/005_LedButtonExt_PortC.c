 ...
 *  			  on external button press(Port C Pin 13)
 */
...
#include<string.h>
#define LOW 0
#define BTN_PRESSED LOW									/*. Button is connected to Port C Pin 13 and is pulled up. When the Button is pressed, Pin 13 is driven to GROUND */
